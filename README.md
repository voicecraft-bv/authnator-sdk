# Authnator PHP API library

> [!NOTE]
> The Authnator PHP API Library is currently in **beta** and we're excited for you to experiment with it!
>
...
When the library is unable to connect to the API, or if the API returns a non-success status code (i.e., 4xx or 5xx response), a subclass of `Authnator\Core\Exceptions\APIException` will be thrown:
